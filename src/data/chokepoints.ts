...
export const CHOKEPOINTS: Chokepoint[] = [
  ...
  { name: 'Bab el-Mandeb', lat: 12.6, lng: 43.3, width: '26 km', dailyTraffic: '~40 vessels', oilFlow: '6.2M bbl/day', risk: 'critical', threat: 'Houthi attacks' },
  ...
  { name: 'Taiwan Strait', lat: 24.0, lng: 118.5, width: '130 km', dailyTraffic: '~90 vessels', oilFlow: '5M bbl/day', risk: 'high', threat: 'China-Taiwan tensions' },
