...
export const NUCLEAR_SITES: NuclearSite[] = [
  ...
  { name: 'Dimona Nuclear Facility', lat: 31.153, lng: 35.123, country: 'Israel', type: 'weapons', status: 'active', risk: 'high' },
  { name: 'Bushehr NPP', lat: 28.965, lng: 50.839, country: 'Iran', type: 'power_plant', status: 'active', risk: 'medium' },
  ...
  { name: 'Barakah NPP', lat: 24.435, lng: 52.428, country: 'UAE', type: 'power_plant', status: 'active', risk: 'low' },
